...
// Centralized mock navigation items
export const NAV_ITEMS: NavItem[] = [
  { key: 'section-studio', section: 'BakeCake Studio', label: '' },
  {
    key: 'dashboard',
    label: 'Dashboard',
    href: '/dashboard',
  ...
  { key: 'users', label: 'Users & Roles', icon: 'users', roles: ['SUPER_ADMIN'], href: '/users' },
  { key: 'settings', label: 'Settings', icon: 'cog', roles: ['SUPER_ADMIN'], href: '/settings' },
  { key: 'audit', label: 'Audit Log', icon: 'clock', roles: ['SUPER_ADMIN'], href: '/audit' },
];
